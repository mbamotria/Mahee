...
const LIFE_CARDS = [
  { icon:"♪", title:"Music", color:"#c9a84c", items:[{l:"Mr. Kitty",s:"synthwave / dark electronic"},{l:"Skillet",s:"alternative rock"},{l:"Aftermath",s:"Bangla rock"},{l:"Anime OSTs",s:"always, forever"}], note:"Music runs during every workout, every commute, every late-night cook session.", link:{label:"SPOTIFY →",href:"https://open.spotify.com/user/31z4vpugeplruvel67xyf4icct6i?si=0912baeea6bb4f5d"} },
